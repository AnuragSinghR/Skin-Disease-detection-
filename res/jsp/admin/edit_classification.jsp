...
<html>
<head>
	<title>Skin Disease Detection System Technologies Using Image Processing and Deep Learning</title>
...
<div class="TabMenu" style="position: relative;left:25px;">
	<h2>Upadte Skin Disease Classification Details<h2>
</div>	
<br>
		 ...
		 <table align="center" id="login">
		   <form action="<%=request.getContextPath()%>/ClassificationList">
		  		...
		  		<tr>
		  				...
		  				<td>
		  						<input type="text" class="field" name="name" value="<%=classificationName%>" required="required" autofocus="autofocus" title="Enter The Face Classification Name."/>
		  				</td>
		  		</tr>
...
%>
		<div class="success" id="message" style="position:absolute;top:60px;left:270px">	
			<p>Skin Disease Classification Details Added Successfully...</p>
		</div>				
<%
	}
	if(no==2)
...
%>
			<div class="error" id="message" style="position:absolute;top:60px;left:270px">	
				<p>Sorry,The Skin disease Classification Already Exists!!!!!</p>
			</div>			
<%
	}
	if(no==3)
